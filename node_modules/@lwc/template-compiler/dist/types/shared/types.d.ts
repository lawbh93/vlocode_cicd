...
export declare type HTMLComment = parse5.AST.Default.CommentNode;
export declare type HTMLText = parse5.AST.Default.TextNode;
export declare type HTMLElement = parse5.AST.Default.Element;
