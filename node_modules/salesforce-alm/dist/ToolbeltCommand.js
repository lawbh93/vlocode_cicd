...
const perfMetricsRequest_1 = require("./lib/perfMetricsRequest");
...
class ToolbeltCommand extends command_1.SfdxCommand {
    ...
    getJsonResultObject(result, status) {
    ...
    static logPerfMetrics(obj) {
        if (perfMetricsRequest_1.requestPerfMetrics.length > 0) {
            obj.perfMetrics = perfMetricsRequest_1.requestPerfMetrics;
            srcDevUtil.saveGlobalConfig('apiPerformanceLog.json', perfMetricsRequest_1.requestPerfMetrics);
        }
        return obj;
    }
}
