...
const messages = core_1.Messages.loadMessages('salesforce-alm', 'reporterCommand');
/**
 ...
 */
class ReporterCommand extends ToolbeltCommand_1.ToolbeltCommand {
    static get flags() {
        if (!this.flagsConfig) {
            this.flagsConfig = {};
        }
        this.flagsConfig.resultformat = command_1.flags.enum(Object.assign({
            char: 'r',
...
exports.ReporterCommand = ReporterCommand;
ReporterCommand.resultFormatOptions = {};

//# sourceMappingURL=ReporterCommand.js.map
