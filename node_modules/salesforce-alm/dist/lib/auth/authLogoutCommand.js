...
const _logout = function (orgApi, orgsToLogout) {
    return core_1.ConfigAggregator.create().then(aggregator => {
        if (orgsToLogout && Array.from(orgsToLogout.keys()).length > 0) {
            // Run all the delete promises
            return BBPromise.map(Array.from(orgsToLogout.keys()), orgConfigToDelete => {
                const org = new Org();
        ...
        if (context.flags.all || (!context.flags.targetusername && logger.getEnvironmentMode().isDemo())) {
            ...
            return new BBPromise(resolve => {
                ...
                if (!context.org) {
                    ...
                    const noOrgFoundErr = Error(message);
...
module.exports = AuthLogoutCommand;

//# sourceMappingURL=authLogoutCommand.js.map
