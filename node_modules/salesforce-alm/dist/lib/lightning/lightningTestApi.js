...
const Reporters = require("../test/reporter");
const TestResults = require("../test/testResults");
const SeleniumRunner = require("../test/seleniumRunner");
...
class LightningTestApi {
    ...
    initialize(options = {}) {
        ...
        if (!reporter) {
            return BBPromise.reject(almError({ keyName: 'lightningTestInvalidReporter', bundle: 'lightning_test' }, Object.keys(ReporterTypes).join(',')));
        }
     ...
     */
    runTests() {
        this.reporter.log(this.targetusername ? `Invoking Lightning tests using ${this.targetusername}...` : 'Invoking Lightning tests...');
        // Default configs
        let driverOptions = {
            desiredCapabilities: {
                browserName: 'chrome'
