...
const PackageInstallCommand = require("../package/packageInstallCommand");
const logApi = require("../core/logApi");
module.exports = class LightningTestInstallCommand {
    constructor() {
    ...
    execute(context) {
        const org = this.org;
        const releaseVersion = context.releaseversion && context.releaseversion !== 'latest' ? `tags/${context.releaseversion}` : 'latest';
        ...
        return new Promise((resolve, reject) => {
            this.request({
                ...
                if (content.message === 'Not Found') {
                    return reject(new Error(this.messages.getMessage('invalidVersion', [context.releaseversion], 'lightning_test')));
                }
                ...
                if (regExMatch && regExMatch.length === 2) {
                    ...
                    this.logger.debug(`Unable to map test framework to package id using the release description, ${releaseMsg}`);
