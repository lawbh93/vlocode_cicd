...
class MdRetrieveApi {
    ...
    validate(context) {
        ...
        if (options.sourcedir) {
            validationPromises.push(this._validatePath(options.sourcedir, data => data.isDirectory(), () => BBPromise.resolve(), almError('InvalidArgumentDirectoryPath', ['sourcedir', options.sourcedir])));
        }
        else if (options.unpackaged) {
            validationPromises.push(this._validatePath(options.unpackaged, data => data.isFile(), () => BBPromise.resolve(), almError('InvalidArgumentFilePath', ['unpackaged', options.unpackaged])));
        }
