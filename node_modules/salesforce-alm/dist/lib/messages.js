...
const messages = {
    default: {
        en_US: {
            ...
            apexTestApiIncorrectTestLevel: 'When specifying classnames, suitenames, or tests, the provided testlevel must be RunSpecifiedTests',
    ...
    apex: {
        en_US: {
            ...
            apexTestCommandParamTestNamesLong: 'Comma-separated list of Apex test class names to run. You can specify only one of ' +
                'classnames, suitenames, or tests.',
            apexTestCommandParamTestSuites: 'comma-separated list of Apex test suite names to run',
            apexTestCommandParamTestSuitesLong: 'Comma-separated list of Apex test suite names to run. You can only specify one of ' +
                'classnames, suitenames, or tests.',
            apexTestCommandParamTests: 'comma-separated list of Apex test class names or IDs and, if applicable, test methods to run',
            apexTestCommandParamTestsLong: 'Comma-separated list of Apex test class names or IDs and test methods, if applicable, ' +
    ...
    package_create: {
        en_US: {
            ...
            orgDependentLong: 'Package depends on unpackaged metadata in the installation org. Applies to  unlocked packages only. (Beta)\n' +
                '\n' +
    ...
    package_version_create: {
        en_US: {
            ...
            releaseNotesUrlLong: 'The release notes URL. This link is displayed in the package installation UI to provide release notes ' +
                'for this package version to subscribers.',
            skipValidation: 'skip validation during package version creation; package versions created without validation can’t be promoted',
    ...
    lightning_test: {
        en_US: {
            ...
            lightningTestCommandDescriptionLong: 'Runs Aura component tests. The Lightning Testing Service (LTS) ' +
            ...
            lightningTestCommandParamLeaveBrowserOpenLong: 'Leaves browser open after the test finishes so that you can view ' + 'the test suite results.',
            ...
            testRunError: 'Something went wrong with the test run. It might be an environmental or configuration issue.' +
                '\nError Message: %s',
            lightningTestingServiceDeprecated: 'The functionality has been moved to a plugin that you must install seperately. ' +
    ...
    limits: {
        en_US: {
            ...
            mainTopicLongDescriptionHelp: 'Use the limits commands to view your org’s limits ' + 'and how close you are to reaching them.'
        }
    },
    schema: {
        en_US: {
    ...
    org_shape: {
        en_US: {
            ...
            create_shape_command_definitionfile: 'creates a scratch definition file based on the specified source org. If a file name isn’t specified, the default is: <source org ID>-<unique 15-character ID>-scratch-def.json',
            create_shape_command_definitionfile_long: 'Creates a scratch definition file based on the specified source org. This name must end in scratch-def.json. If you specify a name that doesn’t end in scratch-def.json, we’ll append it. The file is generated in the config directory.',
