...
const _sourceState = require("./sourceState");
...
class SourcePathStatusManager extends kit_1.AsyncCreatable {
    ...
    async init() {
        ...
        this.fileMoveLogger = await core_2.Logger.child('FileMoves');
        const workspaceOpts = {
            org: this.org,
    ...
    async getSourcePathInfos(filter = {}) {
        ...
        let processedSourcePathInfos = new Map();
    ...
    processFileMoves(addedSourcePathInfos, deletedSourcePathInfos, processedSourcePathInfos) {
...
function rootDirNotSourceDir(packageDirPath, trackedPackages) {
