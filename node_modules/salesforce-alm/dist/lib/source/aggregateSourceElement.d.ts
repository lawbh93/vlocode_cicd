...
export declare class AggregateSourceElement {
     ...
     * @returns {Array[]}
     */
    commit(manifest: any, unsupportedMimeTypes: string[], forceoverwrite?: boolean): [string[], string[], string[]];
    /**
     ...
     * @returns {Array}
     */
    getFilePathTranslations(mdDir: any, tmpDir: any, unsupportedMimeTypes?: string[], forceIgnore?: any): any;
