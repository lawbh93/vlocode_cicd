...
export declare abstract class SourceDeployApiBase extends AsyncCreatable<SourceDeployApiBase.Options> {
     ...
     */
    removeFailedAggregates(componentFailures: any, deployedSourceElements: AggregateSourceElements, packageInfoCache: PackageInfoCache): void;
    /**
