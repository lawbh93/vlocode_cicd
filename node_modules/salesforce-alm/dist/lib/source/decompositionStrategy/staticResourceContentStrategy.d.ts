...
export declare class StaticResourceContentStrategy implements ContentDecompositionStrategy {
    ...
    saveContent(metadataFilePath: any, retrievedContentFilePaths: any, retrievedMetadataFilePath: any, createDuplicates: any, unsupportedMimeTypes: string[], forceoverwrite?: boolean): [string[], string[], string[], string[]];
}
