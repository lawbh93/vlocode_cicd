...
class SandboxOrgApi {
    ...
    async querySandboxProcessById(processId) {
        ...
        let record = await this.queryToolingApi(queryStr, 'SandboxProcessNotFoundById', 'MultiSandboxProcessFoundById', [processId], [processId]);
    ...
    async querySandboxProcessBySandboxOrgId(sandboxOrgId) {
        ...
        let record = await this.queryToolingApi(queryStr, 'sandboxProcessNotFoundByOrgId', 'multiSandboxProcessFoundByOrgId', [sandboxOrgId], [sandboxOrgId]);
        this.logger.debug('Return from calling queryToolingApi: %s ', record);
        return record;
    }
    ...
    async querySandboxInfoIdBySandboxName(sandboxNameIn) {
        ...
        let record = await this.queryToolingApi(queryStr, 'SandboxInfoNotFound', 'MultiSandboxInfoFound', [sandboxNameIn], [sandboxNameIn]);
        this.logger.debug('Return from calling queryToolingApi: %s ', record);
        return record.Id;
    }
    async queryLatestSandboxProcessBySandboxName(sandboxNameIn) {
        ...
        let record = await this.queryToolingApi(queryStr, 'SandboxProcessNotFoundBySandboxName', 'MultiSandboxProcessNotFoundBySandboxName', [sandboxNameIn], [sandboxNameIn]);
        this.logger.debug('Return from calling queryToolingApi: %s ', record);
        return record;
    }
    async queryLatestSandboxProcessBySandboxInfo(sandboxInfoIdIn) {
        ...
        let record = await this.queryToolingApi(queryStr, 'SandboxProcessNotFoundByInfoId', 'MultiSandboxProcessFoundByInfoId', [sandboxInfoIdIn], [sandboxInfoIdIn]);
        this.logger.debug('Return from calling queryToolingApi: %s ', record);
        return record;
    }
