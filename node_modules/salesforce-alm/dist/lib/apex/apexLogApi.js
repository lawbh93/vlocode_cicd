...
class ApexLogApi {
    ...
    async getLogById(logId) {
        let conn = await Config.getActiveConnection({ org: this.org });
        let geturl = util.format('%s/services/data/v%s/tooling/sobjects/ApexLog/%s/Body', conn.instanceUrl, conn.version, logId);
        let log = '';
    ...
    async listLogs() {
        try {
            let conn = await Config.getActiveConnection({
                org: this.org
            });
