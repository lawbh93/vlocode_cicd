...
To deploy an already validated deployment (Quick Deploy):
    ...
    sourcePathLongDescription: 'A comma-separated list of paths to the local source files to deploy. ' +
    ...
    manifestLongDescription: 'The complete path for the manifest (package.xml) file that specifies the components to deploy. All child components are included.' +
