...
${resetHelp}`,
  ...
  resetLongDescription: `Reset local and remote source tracking.
...
${clearHelp}`,
  ...
  clearLongDescription: `Clear all local source tracking information.
...
${clearHelp}`,
  ...
  nopromptLongDescription: 'Do not prompt for source tracking override confirmation.',
  revisionDescription: 'reset to a specific SourceMember revision counter number',
  revisionLongDescription: 'Reset to a specific SourceMember revision counter number.',
  promptMessage:
