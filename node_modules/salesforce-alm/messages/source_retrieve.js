...
To retrieve all metadata from a package and specific components that aren’t in the package, specify both -n | --packagenames and one other scoping parameter:
   ...
   $ sfdx force:source:retrieve -n MyPackageName -x path/to/package.xml`,
    ...
    sourcePathParamLongDescription: 'A comma-separated list of file paths for source to retrieve from the org. ' +
    ...
    manifestParamLongDescription: 'The complete path for the manifest (package.xml) file that specifies the components to retrieve.' +
