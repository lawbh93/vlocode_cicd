...
class SfdxCommand extends command_1.default {
    ...
    async catch(err) {
        ...
        const userDisplayError = Object.assign(this.getJsonResultObject(error.data, error.exitCode), Object.assign(Object.assign({}, error.toObject()), { stack: error.stack, warnings: Array.from(ux_1.UX.warnings) }));
        if (this.isJson) {
