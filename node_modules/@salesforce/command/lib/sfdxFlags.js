...
function merge(kind, flag, describable) {
    ...
    return Object.assign(Object.assign({ kind }, flag), { description: describable.description, longDescription: describable.longDescription });
}
function option(kind, options, parse) {
    const flag = command_1.flags.option(Object.assign(Object.assign({}, options), { parse }));
...
function buildEnum(options) {
    return Object.assign(Object.assign({ kind: 'enum' }, command_1.flags.enum(options)), { options: options.options, description: options.description, longDescription: options.longDescription });
}
...
function buildBuiltin(options = {}) {
    return Object.assign(Object.assign({}, options), { type: 'builtin' });
}
exports.flags = {
    // oclif
    /**
