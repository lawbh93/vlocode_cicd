...
export declare const optionalBuiltinFlags: {
    apiversion(opts?: Optional<flags.Builtin>): flags.Discriminated<flags.String>;
    concise(opts?: Optional<flags.Builtin>): flags.Discriminated<flags.Boolean<boolean>>;
    quiet(opts?: Optional<flags.Builtin>): flags.Discriminated<flags.Boolean<boolean>>;
    targetdevhubusername(opts?: Optional<flags.Builtin>): flags.Discriminated<flags.String>;
    targetusername(opts?: Optional<flags.Builtin>): flags.Discriminated<flags.String>;
    verbose(opts?: Optional<flags.Builtin>): flags.Discriminated<flags.Boolean<boolean>>;
};
/**
