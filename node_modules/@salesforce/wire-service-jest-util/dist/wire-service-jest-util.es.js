...
function buildTestWireAdapter() {
  ...
  return _temp = _class = class TestWireAdapter extends TestWireAdapterTemplate {}, _defineProperty(_class, "_lastConfig", null), _defineProperty(_class, "_wireInstances", new Set()), _temp;
}
...
function buildApexTestWireAdapter() {
  ...
  return _temp = _class = class ApexTestWireAdapter extends ApexTestWireAdapterTemplate {}, _defineProperty(_class, "_lastConfig", null), _defineProperty(_class, "_wireInstances", new Set()), _temp;
}
...
function buildLdsTestWireAdapter() {
  ...
  return _temp = _class = class LdsTestWireAdapter extends LdsTestWireAdapterTemplate {}, _defineProperty(_class, "_lastConfig", null), _defineProperty(_class, "_wireInstances", new Set()), _temp;
}
